...
folder_name = '20240712';  

% Define the controller folder name
folder_controller = 'PID';

% Define the workspace filename
workspace_filename = 'workspace_log_20240712_150116.mat';

% Extract year and month from the folder_name
folder_year = folder_name(1:4);
folder_month = folder_name(5:6);

% Construct the full path to the workspace file
workspace_path = fullfile('..',folder_year, folder_month, folder_name, ...
  folder_controller, 'workspaces', workspace_filename);
...
xlabel('$t$ [s]','interpreter','latex','fontsize',font_size)
ylabel('Roll accel [rad/s$^2$]','interpreter','latex','fontsize',font_size)
title(folder_controller,'interpreter','latex','fontsize',font_size_title)
axis tight
hold off
xlim([x_lim_min,x_lim_max])
...
xlabel('$t$ [s]','interpreter','latex','fontsize',font_size)
ylabel('Pitch accel [rad/s$^2$]','interpreter','latex','fontsize',font_size)
axis tight
hold off
xlim([x_lim_min,x_lim_max])
...
xlabel('$t$ [s]','interpreter','latex','fontsize',font_size)
ylabel('Yaw accel [rad/s$^2$]','interpreter','latex','fontsize',font_size)
axis tight
hold off
xlim([x_lim_min,x_lim_max])
...
%% Plot OUTER LOOP Dynamic inversion control input
...
xlabel('$t$ [s]','interpreter','latex','fontsize',font_size)
ylabel('Outer loop dynamic inversion control input [N]','interpreter','latex','fontsize',font_size)
title('PID','interpreter','latex','fontsize',font_size_title)
hold off
axis tight
xlim([x_lim_min,x_lim_max])
