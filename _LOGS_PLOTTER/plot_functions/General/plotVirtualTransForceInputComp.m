...
subplot(3,1,1)
plot(log.time,log.mu_translational_raw.x,'r-','LineWidth',2)
hold on
...
subplot(3,1,2)
plot(log.time,log.mu_translational_raw.y,'r-','LineWidth',2)
hold on
...
subplot(3,1,3)
plot(log.time,log.mu_translational_raw.z,'r-','LineWidth',2)
hold on
