...
if isfield(gains, 'ADAPTIVE')
    S_diag = gains.ADAPTIVE.S_diagonal_g_rotational;
    alpha = gains.ADAPTIVE.alpha_g_rotational;
elseif isfield(gains, 'S_diagonal_g_rot')
    S_diag = gains.S_diagonal_g_rot;
    alpha = gains.alpha_g_rot;
else
    error('Unknown gain structure: Cannot find S_diagonal_g_rotational or S_diagonal_g_rot.');
end
