function [der, controller_matrices] = computeDerivedValues_mrac(der, log, vp, gains)
%COMPUTEDERIVEDVALUES Compute derived values from the log values

    controller_matrices = controllerMatrices_MRAC(vp, gains);

    % Compute the omega_ref_dot
    ...
    for ii = 1:length(log.time)
        ...
        K_hat_x_dot_outer_loop = -gains.ADAPTIVE.Gamma_x_translational * ...
                                  log.outer_loop.dead_zone_value(ii) * ( ...
                                    ...
                                    + gains.ADAPTIVE.sigma_x_translational * ...
                                      norm(tracking_error_translational' * ...
                                           controller_matrices.P_translational * ...
                                           controller_matrices.B_translational) * ...
                                      K_hat_x_outer_loop);
        ...
        K_hat_r_dot_outer_loop = -gains.ADAPTIVE.Gamma_r_translational * ... 
                                  log.outer_loop.dead_zone_value(ii) * ( ...
                                    r_cmd_outer_loop * ...
                                    tracking_error_translational' * ...
                                    controller_matrices.P_translational * ...
        ...
        Theta_hat_dot_outer_loop = gains.ADAPTIVE.Gamma_Theta_translational * ...
                                   log.outer_loop.dead_zone_value(ii) * ( ...
                                    phi_outer_loop * ...
                                    tracking_error_translational' * ...
                                    controller_matrices.P_translational * ...
        ...
        K_hat_x_dot_inner_loop = -gains.ADAPTIVE.Gamma_x_rotational * ...
                                  log.inner_loop.dead_zone_value(ii) * ( ...
                                    ...
                                    + gains.ADAPTIVE.sigma_x_rotational * ...
                                      norm(tracking_error_rotational' * ...
                                           controller_matrices.P_rotational * ...
                                           controller_matrices.B_rotational) * ...
                                      K_hat_x_inner_loop);
        ...
        K_hat_r_dot_inner_loop = -gains.ADAPTIVE.Gamma_r_rotational * ... 
                                  log.inner_loop.dead_zone_value(ii) * ( ...
                                    r_cmd_inner_loop * ...
                                    tracking_error_rotational' * ...
                                    controller_matrices.P_rotational * ...
        ...
        Theta_hat_dot_inner_loop = gains.ADAPTIVE.Gamma_Theta_rotational * ...
                                   log.inner_loop.dead_zone_value(ii) * ( ...
                                    phi_inner_loop * ...
                                    tracking_error_rotational' * ...
                                    controller_matrices.P_rotational * ...
