function der = computeDerivedValues_FunTLMRAC(der, log, vp, gains)
%COMPUTEDERIVEDVALUES Compute derived values from the log values
    ...
    for ii = 1:length(log.time)
        ...
        K_hat_x_dot_outer_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_x_translational, ...
          gains.DER.S_x_translational);
        ...
        K_hat_r_dot_outer_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_r_translational, ...
          gains.DER.S_r_translational);
        ...
        Theta_hat_dot_outer_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_Theta_translational, ...
          gains.DER.S_Theta_translational);
        ...
        K_hat_g_dot_outer_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_g_translational, ...
          gains.DER.S_g_translational);
        ...
        K_hat_x_dot_inner_loop = adaptiveLawDeadzoneEmodification( ...
          ...
          gains.DER.P_rotational, ...
          gains.DER.B_rotational, ...
        ...
        K_hat_x_dot_inner_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_x_rotational, ...
          gains.DER.S_x_rotational);
        ...
        K_hat_r_dot_inner_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_r_rotational, ...
          gains.DER.S_r_rotational);
        ...
        Theta_hat_dot_inner_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_Theta_rotational, ...
          gains.DER.S_Theta_rotational);
        ...
        K_hat_g_dot_inner_loop = projectionMatrix( ...
          ...
          gains.DER.epsilon_g_rotational, ...
          gains.DER.S_g_rotational);
        ...
        der.outer_loop.tracking_error_dot_vector(ii,:) = ...
            [log.outer_loop.tracking_error_dot.x(ii);
             log.outer_loop.tracking_error_dot.y(ii);
             log.outer_loop.tracking_error_dot.z(ii);
             log.outer_loop.tracking_error_dot.vx(ii);
             log.outer_loop.tracking_error_dot.vy(ii);
             log.outer_loop.tracking_error_dot.vz(ii)];

        % OUTER LOOP trajectory tracking error derivative norm
        der.outer_loop.tracking_error_dot_norm(ii,1) = ... 
            norm(der.outer_loop.tracking_error_dot_vector(ii));

        

    end

    % % OUTER LOOP trajectory tracking error L2norm
    % der.outer_loop.tracking_error_L2norm = sqrt(cumtrapz(log.time, der.outer_loop.tracking_error_norm.^2));
