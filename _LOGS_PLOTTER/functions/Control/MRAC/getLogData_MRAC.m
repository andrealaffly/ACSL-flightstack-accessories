function log = getLogData_MRAC(LogDataMatrix)
%GETLOGDATA_MRAC Extract log data for the MRAC controller
    ...
    log.outer_loop.proj_op_activated_K_hat_x = LogDataMatrix(:, 216);
    log.outer_loop.proj_op_activated_K_hat_r = LogDataMatrix(:, 217);
    log.outer_loop.proj_op_activated_Theta_hat = LogDataMatrix(:, 218);
    log.inner_loop.proj_op_activated_K_hat_x = LogDataMatrix(:, 219);
    log.inner_loop.proj_op_activated_K_hat_r = LogDataMatrix(:, 220);
    log.inner_loop.proj_op_activated_Theta_hat = LogDataMatrix(:, 221);
