function controller_matrices = initializeProjectionEllipsoidParams_TLMRAC(gains, controller_matrices)
...
controller_matrices.S_g_translational = ...
  generateEllipsoidMatrixFromDiagonal(gains.ADAPTIVE.S_diagonal_g_translational);
...
controller_matrices.S_g_rotational = ...
  generateEllipsoidMatrixFromDiagonal(gains.ADAPTIVE.S_diagonal_g_rotational);
...
controller_matrices.epsilon_g_translational = ...
  computeEpsilonFromAlpha(gains.ADAPTIVE.alpha_g_translational);
...
controller_matrices.epsilon_g_rotational = ...
  computeEpsilonFromAlpha(gains.ADAPTIVE.alpha_g_rotational);
