function [der, controller_matrices] = computeDerivedValues_TLMRAC(der, log, vp, gains)
%COMPUTEDERIVEDVALUES Compute derived values from the log values

    controller_matrices = controllerMatrices_TLMRAC(vp, gains);
    ...
    for ii = 1:length(log.time)
        ...
        K_hat_r_dot_outer_loop = adaptiveLawDeadzoneEmodification( ...
        ...
        Theta_hat_dot_outer_loop = adaptiveLawDeadzoneEmodification( ...
        ...
        K_hat_g_dot_outer_loop = adaptiveLawDeadzoneEmodification( ...
