...
%COMPUTEDERIVEDVALUES Compute derived values from the log values
    ...
    der.translational_position_error.L2norm = ...
      computeL2norm(log.time, der.translational_position_error.norm, 10);
    ...
    der.translational_velocity_error.L2norm = ...
      computeL2norm(log.time, der.translational_velocity_error.norm, 10);
    ...
    der.total_thrust_motors_N_L2norm = ...
      computeL2norm(log.time, der.total_thrust_motors_N, 10);
