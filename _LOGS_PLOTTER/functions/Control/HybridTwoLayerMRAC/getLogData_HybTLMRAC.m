function log = getLogData_HybTLMRAC(LogDataMatrix)
%GETLOGDATA_HYBTLMRAC Extract log data for the Hybrid Two-Layer MRAC controller
    ...
    log.outer_loop.Derivative_filtered.x = LogDataMatrix(:, 259);
    log.outer_loop.Derivative_filtered.y = LogDataMatrix(:, 260);
    log.outer_loop.Derivative_filtered.z = LogDataMatrix(:, 261);

    log.outer_loop.hybrid.integral_eQe = LogDataMatrix(:, 262);
    log.outer_loop.hybrid.summation_P = LogDataMatrix(:, 263);
    log.outer_loop.hybrid.s_series = LogDataMatrix(:, 264);
    log.outer_loop.hybrid.time_of_last_trajectory_reset = LogDataMatrix(:, 265);
    log.outer_loop.hybrid.eQe = LogDataMatrix(:, 266);

    log.outer_loop.trajectory_tracking_error.x = LogDataMatrix(:, 267);
    log.outer_loop.trajectory_tracking_error.y = LogDataMatrix(:, 268);
    log.outer_loop.trajectory_tracking_error.z = LogDataMatrix(:, 269);
    log.outer_loop.trajectory_tracking_error.vx = LogDataMatrix(:, 270);
    log.outer_loop.trajectory_tracking_error.vy = LogDataMatrix(:, 271);
    log.outer_loop.trajectory_tracking_error.vz = LogDataMatrix(:, 272);

    log.outer_loop.previous_trajectory_tracking_error.x = LogDataMatrix(:, 273);
    log.outer_loop.previous_trajectory_tracking_error.y = LogDataMatrix(:, 274);
    log.outer_loop.previous_trajectory_tracking_error.z = LogDataMatrix(:, 275);
    log.outer_loop.previous_trajectory_tracking_error.vx = LogDataMatrix(:, 276);
    log.outer_loop.previous_trajectory_tracking_error.vy = LogDataMatrix(:, 277);
    log.outer_loop.previous_trajectory_tracking_error.vz = LogDataMatrix(:, 278);

    log.mu_adaptive_ebci_translational.x = LogDataMatrix(:, 279);
    log.mu_adaptive_ebci_translational.y = LogDataMatrix(:, 280);
    log.mu_adaptive_ebci_translational.z = LogDataMatrix(:, 281);

    log.mu_adaptive_mrac_translational.x = LogDataMatrix(:, 282);
    log.mu_adaptive_mrac_translational.y = LogDataMatrix(:, 283);
    log.mu_adaptive_mrac_translational.z = LogDataMatrix(:, 284);
